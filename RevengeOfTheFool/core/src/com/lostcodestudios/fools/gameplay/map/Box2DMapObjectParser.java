...
public class Box2DMapObjectParser {
	...
	public Body createBody(World world, MapObject mapObject) {
		...
		bodyDef.position.set((Float) getProperty(properties, "x", bodyDef.position.x, Float.class) * unitScale, (Float) getProperty(properties, "y", bodyDef.position.y, Float.class) * unitScale);
	...
	private Object getProperty(MapProperties properties, String property, Object defaultValue, Class<?> clazz) {
		if(clazz == Float.class)
			return properties.get(property, String.class) != null ? properties.get(property, Float.class) : defaultValue;
